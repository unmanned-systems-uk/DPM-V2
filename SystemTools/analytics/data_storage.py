        ...
        with self.lock:
            try:
                ...
                ''', (
                    ...
                    camera.get('camera_connected') if camera.get('camera_connected') is not None else camera.get('connected'),
                    camera.get('camera_latency_ms') if camera.get('camera_latency_ms') is not None else camera.get('sdk_latency_ms'),
                    camera.get('camera_usb_traffic_mbps') if camera.get('camera_usb_traffic_mbps') is not None else camera.get('usb_traffic_mbps'),
                    camera.get('camera_error_count') if camera.get('camera_error_count') is not None else camera.get('error_count'),
                    network.get('tcp_connected'),
                    network.get('tcp_latency_ms'),
                    network.get('udp_loss_percent'),
                    network.get('queue_depth') if network.get('queue_depth') is not None else network.get('command_queue_depth'),
