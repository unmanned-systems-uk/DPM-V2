...
- ALWAYS update protocol JSON files BEFORE implementing network commands. protocol/commands.json is the single source of truth. If Air-Side and SystemTools disagree, check the protocol 
  first.
- ALWAYS update protocol JSON files BEFORE implementing network commands. protocol/commands.json is the single source of truth. If Air-Side and SystemTools disagree, check the protocol 
  first.
- ALWAYS update protocol JSON files BEFORE implementing network commands. protocol/commands.json is the single source of truth. If Air-Side and SystemTools disagree, check the protocol 
